...
[CreateAssetMenu(fileName = "New GameEvent", menuName = "Example3/Events/GameEvent", order = 1)]
public class E3_GameEvent : ScriptableObject
{
    // List of Listeners this Event will notify when triggered/raised.
    private List<E3_GameEventListener> listeners = new List<E3_GameEventListener>();
    ...
    public void RegisterListener(E3_GameEventListener listener)
    {
    ...
    public void UnregisterListener(E3_GameEventListener listener)
    {
        if (listeners.Contains(listener))
